...
tstdata_tmp,trndata_tmp = alldata.splitWithProportion(0.25) # split data into 75% training data and 25% test data
...
# Now we have built a feed-forward network with 5 hidden units
...
griddata._convertToOneOfMany() # needed to make fnn feel comfy
